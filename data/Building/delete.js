 ...
 */
async function validateAndCleanDeleteBuilding(
    buildingId,
    name,
    location,
    washers,
  ...
  if (!await Building.exists({name})) {
    throw new Error('Refusing to delete a non-existant building');
  }
...
async function deleteBuilding(
  ...
  ({buildingId, name, location, washers, driers, accessGroups} =
    await validateAndCleanDeleteBuilding(
        buildingId,
        name,
        location,
        washers,
    ...
    return await Building.deleteOne({_id: buildingId});
