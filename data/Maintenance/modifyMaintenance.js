...
/**
 * modify a period of planned maintenance
 * @param {String} startDate
 * @param {String} endDate
 * @param {String} machineId ObjectId in string form
 * @param {String} note The note re why maintenance is occurring
 * @return {Object}
 */
async function modifyMaintenance(startDate, endDate, machineId, note) {
  ...
  return await Maintenance.updateOne({machineId:{$eq:machineId}},{$set:{
...
module.exports = modifyMaintenance;
